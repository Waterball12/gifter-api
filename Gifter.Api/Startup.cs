...
namespace Gifter.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Gifter.Api", Version = "v1" });
            });
            ...
            {
                var config = sp.GetRequiredService<IOptions<GiftContextOptions>>();

                return new GiftContext(config.Value);
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Gifter.Api v1"));
            }
